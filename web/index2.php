...
<div class="row">
  <div class="col-sm-1">
    <a button class="button button2" href="pdf.php"><i class='fas fa-download'></i>PDF</button></a><br><br>
  </div>
  <div class="col-sm-1">
    <a button class="button button2" href="sam.php?export=true"><i class='fas fa-download'></i>excel</button></a>
  </div>
</div>
